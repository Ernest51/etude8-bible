...
// Rubriques d'étude biblique (29 sections) - Adaptées de votre capture
const STUDY_SECTIONS = [
  { id: 0, title: "Étude verset par verset", subtitle: "Analyse détaillée de...", progress: 85 },
  { id: 1, title: "Prière d'ouverture", subtitle: "Invocation de l'Esprit Saint...", progress: 70 },
  { id: 2, title: "Structure littéraire", subtitle: "Analyse de l'architecture...", progress: 60 },
  { id: 3, title: "Questions du chapitre précédent", subtitle: "Synthèse", progress: 45 },
  { id: 4, title: "Thème doctrinal", subtitle: "Enseignements centraux...", progress: 30 },
  { id: 5, title: "Fondements théologiques", subtitle: "Bases scripturaires...", progress: 25 },
  { id: 6, title: "Références croisées", subtitle: "Liens avec autres passages...", progress: 20 },
  { id: 7, title: "Application personnelle", subtitle: "Mise en pratique...", progress: 15 },
  { id: 8, title: "Fruits spirituels", subtitle: "Croissance et transformation...", progress: 10 },
  { id: 9, title: "Mots-clés théologiques", subtitle: "Termes importants...", progress: 8 },
  { id: 10, title: "Symboles et métaphores", subtitle: "Langage figuré...", progress: 7 },
  { id: 11, title: "Parallèles canoniques", subtitle: "Échos bibliques...", progress: 6 },
  { id: 12, title: "Contexte historique", subtitle: "Arrière-plan culturel...", progress: 5 },
  { id: 13, title: "Genre littéraire", subtitle: "Style et forme...", progress: 4 },
  { id: 14, title: "Progression narrative", subtitle: "Développement du récit...", progress: 3 },
  { id: 15, title: "Personnages clés", subtitle: "Acteurs principaux...", progress: 2 },
  { id: 16, title: "Géographie biblique", subtitle: "Lieux et régions...", progress: 1 },
  { id: 17, title: "Chronologie", subtitle: "Repères temporels...", progress: 1 },
  { id: 18, title: "Langue originale", subtitle: "Hébreu et grec...", progress: 1 },
  { id: 19, title: "Traditions manuscrites", subtitle: "Variantes textuelles...", progress: 1 },
  { id: 20, title: "Commentaires patristiques", subtitle: "Pères de l'Église...", progress: 1 },
  { id: 21, title: "Exégèse moderne", subtitle: "Approches contemporaines...", progress: 1 },
  { id: 22, title: "Implications pastorales", subtitle: "Application en Église...", progress: 1 },
  { id: 23, title: "Dimension prophétique", subtitle: "Aspects eschatologiques...", progress: 1 },
  { id: 24, title: "Typologie christologique", subtitle: "Préfigurations du Christ...", progress: 1 },
  { id: 25, title: "Dimension sacramentelle", subtitle: "Mystères de la foi...", progress: 1 },
  { id: 26, title: "Spiritualité contemplative", subtitle: "Méditation profonde...", progress: 1 },
  { id: 27, title: "Mission et témoignage", subtitle: "Partage de la foi...", progress: 1 },
  { id: 28, title: "Synthèse finale", subtitle: "Récapitulatif et conclusion...", progress: 1 }
];
